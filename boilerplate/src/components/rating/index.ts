...
export class CaseRating extends LitElement {
  ...
  protected render() {
    ...
    ${Array.from({ length: this.numberOfStars }, (_, i) => {
      return html`<svg @click=${this.isComponentDisabled ? () => { } : () => this.handleStarClick(i)} class="${this.getStarClassName(i)}"  width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
